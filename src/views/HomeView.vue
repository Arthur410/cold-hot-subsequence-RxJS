<template>
  <div class="home">
    <HelloWorld msg="This is home page"/>
    <div class="logs">
...
import {
  ...
  startWith,
  switchMap,
  EMPTY, skipUntil, skipWhile, skip, Subscription
} from 'rxjs'
...
@Options({
  ...
  computed: {
    getLogs: function () {
      ...
      this.logs.forEach((el: number) => {
        strLogs.push(`survey ${counter} take ${el} sec`)
        counter += 1
      })
